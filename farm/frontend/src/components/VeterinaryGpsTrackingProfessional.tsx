...
const VeterinaryGpsTracking: React.FC = () => {
  ...
  const demoVeterinarians = [
    ...
    },
    {
      ...
      isVerified: true,
      services: ['Goat Care', 'Sheep Health', 'Poultry Management', 'Small Animal Surgery'],
      availability: {
        monday: { available: true, timings: '9:00 AM - 6:00 PM' },
        tuesday: { available: true, timings: '9:00 AM - 6:00 PM' },
        wednesday: { available: true, timings: '9:00 AM - 6:00 PM' },
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="h-[650px] shadow-xl border-0">
                ...
                <div>
                  ...
                  <Select value={selectedAnimalType} onValueChange={setSelectedAnimalType}>
                    ...
                    <SelectContent className="border-2 border-gray-200">
                      ...
                      <SelectItem value="Ducks">
                        <div className="flex items-center gap-2">
                          <span>🦆</span>
                          <span>Ducks</span>
                        </div>
                      </SelectItem>
                      <SelectItem value="Turkeys">
                        <div className="flex items-center gap-2">
                          <span>🦃</span>
                          <span>Turkeys</span>
                        </div>
                      </SelectItem>
                      <SelectItem value="Camels">
                        <div className="flex items-center gap-2">
                          <span>🐪</span>
                          <span>Camels</span>
                        </div>
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Try expanding your search radius or selecting a different animal type.
                      </p>
                      <div className="space-y-2 text-left">
                        <div className="text-sm text-gray-600 bg-blue-50 p-3 rounded-lg">
                          <span className="font-semibold text-blue-700">💡 Tip:</span> Make sure GPS is enabled in your browser
                        </div>
                        <div className="text-sm text-gray-600 bg-green-50 p-3 rounded-lg">
                          <span className="font-semibold text-green-700">📍 Location:</span> Veterinarians are shown within {searchRadius}km
                        </div>
                        <div className="text-sm text-gray-600 bg-purple-50 p-3 rounded-lg">
                          <span className="font-semibold text-purple-700">🐄 Specialization:</span> Filter by animal type for better results
                        </div>
                      </div>
                    </div>
                  </div>
