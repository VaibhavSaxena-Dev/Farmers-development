...
const Marketplace = () => {
  ...
  const vaccineItems: VaccineItem[] = useMemo(() => [
    // VACCINES
    {
      ...
      image: "https://i.ibb.co/4N1v2Jm/fmd-vaccine.jpg",
      inStock: true,
    ...
    },
    {
      ...
      image: "https://i.ibb.co/3pL0bKc/lsd-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Cattle Vaccine",
      sku: "LSD-001",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/6y4xQ7f/bvd-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Cattle Vaccine",
      sku: "BVD-002",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/5pL0bKc/ibr-marker-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Cattle Vaccine",
      sku: "IBR-MK-003",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/8pL0bKc/newcastle-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
    ...
    },
    {
      ...
      image: "https://i.ibb.co/9pL0bKc/fowl-pox-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Poultry Vaccine",
      sku: "FP-005",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/2pL0bKc/ib-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Poultry Vaccine",
      sku: "IB-006",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/7pL0bKc/ppr-vaccine.jpg",
      inStock: true,
      deliveryAvailable: true,
    ...
    // FEED PRODUCTS
    {
      ...
      image: "https://i.ibb.co/1pL0bKc/fodder-green-grass.jpg",
      inStock: true,
      deliveryAvailable: true,
    ...
    },
    {
      ...
      image: "https://i.ibb.co/0pL0bKc/hay-dried-grass.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Animal Feed",
      sku: "HAY-009",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/4pL0bKc/cattle-concentrate-feed.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Animal Feed",
      sku: "CF-010",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/3pL0bKc/mash-feed.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Animal Feed",
      sku: "MF-011",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/5pL0bKc/pellet-feed.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Animal Feed",
      sku: "PF-012",
    ...
    },
    {
      ...
      image: "https://i.ibb.co/6pL0bKc/grain-mix.jpg",
      inStock: true,
      deliveryAvailable: true,
      categoryLabel: "Animal Feed",
      sku: "GM-013",
            ...
            <Card key={item.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="aspect-video relative overflow-hidden">
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src = "https://i.ibb.co/4N1v2Jm/fmd-vaccine.jpg";
                  }}
                />
                {item.inStock && (
